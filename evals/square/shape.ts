...
/**
 * KTD6 bubble gate: one `send_message` call is one iMessage bubble. A normal
 * answer passes at 2 bubbles, warns at 3 (soft), and fails above 3. A list
 * answer with 5+ items must state a count and offer the rest instead of
 * listing them all.
 */
