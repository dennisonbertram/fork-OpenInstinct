...
vi.mock("@/agent/subagents/worker/lib/autofill/provider", () => ({
  vaultAutofillProvider: {},
}));
vi.mock("@/agent/subagents/worker/lib/autofill/service", () => ({
...
vi.mock("@/agent/subagents/worker/lib/vault-browser-guard", () => ({
...
} from "@/agent/subagents/worker/tools/commit_browser_action";
