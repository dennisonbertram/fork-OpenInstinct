...
The coordinator reports the missing synthetic trace correctly returned 404. The decisive screenshot `not-found.png` visibly presents **404** and **This page could not be found.** without protected record content. The text appears almost white on the cream background; it is difficult to distinguish in the rendered capture. The Tasks header is also very light.
