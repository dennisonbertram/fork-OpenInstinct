...
| 08      | Restyle record (shipped 2026-09-03, PR #47): before and now token map, component status, bypasses fixed, counts | all catalogs, `../JORY_DESIGN_MERGE.md`       |
...
Status 2026-09-03: sections 04 to 08 were updated to the values that shipped in the Jory restyle (`../DESIGN_SYSTEM.md`, "Restyle 2026-09-03"). The `oi-*` variables carry the shipped light values; their dark values are the pre-restyle shadcn neutrals. Sections 05 to 07 keep their original layout; only tokens, weights, radii, tone text, field surfaces, bubbles, and captions changed.
