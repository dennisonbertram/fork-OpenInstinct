...
| Plugin author         | [`PLUGINS.md`](PLUGINS.md)                                         | Our authored integrations: native tools, OpenAPI, MCP, skills, optional extension packaging, and deferred distribution |
...
| Plugin author         | [`PLUGIN_TESTING.md`](PLUGIN_TESTING.md)                           | Existing integration checks, maintained mount fixture, real-provider acceptance, and optional future conformance       |
