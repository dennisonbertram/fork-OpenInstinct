...
verification `checks` lane sets `REAL_PG=0` and requires exactly the seven
intentional skips plus non-empty root and marketing test summaries. The
separate `real-postgres` lane is authoritative for those seven cases.
...
| ---------------- | ---------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `checks`         | `pnpm check`, then `git diff --check`                                                                                                    | Both exit successfully; root and marketing Vitest summaries are present and non-empty; no failed or unexpected skipped cases; exactly seven intentional `REAL_PG=0` skips                                                                                                                                                                                                                                                                                                                      |
