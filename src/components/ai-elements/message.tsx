...
export const MessageContent = ({
  ...
  <div
    className={cn(
      ...
      "group-[.is-assistant]:rounded-bubble group-[.is-assistant]:rounded-bl-md group-[.is-assistant]:bg-bubble-assistant group-[.is-assistant]:px-4 group-[.is-assistant]:py-3 group-[.is-assistant]:text-foreground",
      className
    )}
    {...props}
  >
